...
/* harmony import */ var _services_clooneprovider_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../services/clooneprovider.service */ "crRc");
...
let SubmittedDetailsPage = class SubmittedDetailsPage {
    constructor(modalCtrl, navParams, clooneprovider, http) {
    ...
    ngOnInit() {
        ...
        let headers = new _angular_http__WEBPACK_IMPORTED_MODULE_6__["Headers"]({ 'Content-Type': 'application/x-www-form-urlencoded' });
        let postForm = {
...
SubmittedDetailsPage.ctorParameters = () => [
    ...
    { type: _services_clooneprovider_service__WEBPACK_IMPORTED_MODULE_5__["ClooneproviderService"] },
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".card-header {\n  padding: 10px;\n  background-color: lightgrey;\n}\n\n.card-subtitle {\n  margin: 0;\n  color: black;\n  text-transform: capitalize !important;\n  font-size: 0.9em;\n}\n\n.photo {\n  width: 50%;\n}\n\nion-card-content {\n  display: flex;\n  position: relative;\n}\n\n.detailItems {\n  padding-right: 12px;\n  text-transform: none;\n  font-size: 12px;\n  color: gray;\n  --border-width: 0 0 0 0;\n}\n\n.label {\n  font-size: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let TncModalPage = class TncModalPage {
    constructor(modalCtrl, clooneprovider) {
        this.modalCtrl = modalCtrl;
        this.clooneprovider = clooneprovider;
        // public tnc = {
        //   value: false
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header>\n  <ion-toolbar>\n    <ion-buttons slot=\"start\">\n      <ion-button (click)=\"dismiss()\">Close</ion-button>\n    </ion-buttons>\n    <ion-title>Terms & Conditions</ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n  <ion-grid>\n    <ion-list lines=\"full\" class=\"form-list\">\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>1. </b> In-warranty/manufacturer warranty will be carried out subject to warranty validity check by Senheng authorised person.</p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>2. </b> For Product under manufacturer warranty, PlusOne® warranty or V-Care extended warranty, the warranty is only applicable for damage caused by normal use condition and specifically void if:<br>\n          - Warranty seal is broken: - Product is beyond repair condition (oxidized, liquid immersed, physical damages & such other conditions as may be informed by Senheng): or<br>\n          - Product has been opened, modified, tampered with or repaired or attempted to be opened, modified, tampered with or repaired by unauthorized person; or<br>\n          - Product failure is caused by software being corrupted or Product being downloaded with incompatible software The warranties shall not apply if:<br>\n          - Made void by any reason(s) above;<br>\n          - Damaged by use with products not sold or licensed by manufacturer (including, for example, games and accessories not manufactured or licensed by manufacturer, and \"pirated\" games, etc.);<br>\n          - Product used for commercial purposes (including, for example, rental, pay-per-use, etc.);<br>\n          - Damaged by any external cause (including, for example, by being dropped, failure to follow instructions on operation etc.);<br>\n          - Scratched, dented, etc. or shows other cosmetic damage; or - Repaired by anyone other than Senheng.<br></p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>3. </b> Customer shall back up all data and delete anything which Customer deems confidential from the Product on his/her own efforts before sending/ releasing the Product to Senheng. Senheng will not be responsible for any data lost or disclosure.</p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>4. </b> In the event of diagnostic/repair, the Product may be to factory mode without prior notice to Customer.</p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>5. </b> Customer should collect the Product within thirty (30) days from the date of the repair completion notification. Senheng reserves its right to dispose the Product without further notice and liability to Customer if Customer fails to collect the Product within thirty (30) days from the date of repair completion notification. Product shall only be released in exchange of payment of invoice (if any) for non-warrantable parts, inspection and labour cost.</p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>6. </b> Inspection cost, labour cost and parts replacement cost for any non-warrantable parts or Product is at the cost of the Customer.</p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>7. </b> All accessories attached to or accompanying the Product and delivered to Senheng shall be at the risks of Customer and Senheng will not responsible for any loss or damage.</p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>8. </b> Senheng and its employees, affiliates and sub-ctonractors will exercise reasonable care of the Product during possession of the Product; however neither Senheng or any of its employees, affiliates and/or sub-contractor will not responsible for the Product (save for the requested repair areas) or any scratches or cosmetic damage to the Product while carry out any inspection and repairing works.</p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>9. </b> To the extent permitted by law, SENHENG IS NOT responsible FOR ANY INDIRECT, INCIDENTAL, SPECIAL, OR CONSEQUENTIAL DAMAGES; ANY LOSS OF DATA, PRIVACY, CONFIDENTIALITY, OR PROFITS; OR ANY INABILITYTO USE YOUR Product or accessory. THESE EXCLUSIONS APPLY EVEN IF SENHENG HAS BEEN ADVISED OF THE POSSIBILITY OF THESE DAMAGES, AND EVEN IF ANY REMEDY FAILS OF ITS ESSENTIAL PURPOSE.</p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>10. </b> By signing the declaration below, you consent to the disclosure and processing of your personal data by and confirm that you have obtained the consent of such persons to the disclosure of their personal data to Senheng and its employees, affiliates and sub-contractors and undertake to comply with all relevant privacy laws.</p>\n      </ion-item>\n      <ion-item class=\"tncDetails\">\n        <p class=\"smoothed\"><b>11. </b> For the purpose of this form, all reference to “Senheng\" shall include Senheng Electric (KL) Sdn Bhd, its subsidiary companies, employees, authorised affiliates and sub-contractors.</p>\n      </ion-item>\n\n      \n      \n    </ion-list>\n\n    <ion-list lines=\"full\" class=\"form-list\">\n      <ion-item class=\"tncDetails\" *ngFor=\"let item of list\">\n        <ion-checkbox slot=\"start\" color=\"danger\" [(ngModel)]=\"item.isChecked\" (click)=\"checkboxChange()\"></ion-checkbox>\n        <p style=\"padding-left: 12px;\">I agree to the terms & conditions.</p>\n      </ion-item>\n    </ion-list>\n  </ion-grid>\n</ion-content>\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".form-list {\n  margin: 12px 5px 12px 5px;\n  padding: 0;\n  border: 1px solid lightgrey;\n  border-bottom: none;\n}\n\n.tncDetails {\n  font-size: 0.9em;\n  color: black;\n}\n\n.smoothed {\n  font-smooth: always;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
